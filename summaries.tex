...
In their implementation, they choose $\delta = 0.1$ and $d_0 = \min(\text{width,depth,height})$ where width, depth and height are the dimensions of the bouding box of the point cloud.
